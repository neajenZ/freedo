    ...
    return (<header className={styles.header}>
          <div className="container">
              <div ref={userWidjet.ref} className={styles.wrapper}>
                          <button onClick={() => setBurgerMenu(true)} className={styles.burgerBtn}>
                          </button>

                  {isBurgerMenu && (<div className={styles.burgerMenu}>
                              <button onClick={() => setBurgerMenu(false)} className={styles.burgerBtnClosed}>
            ...
            <>
                                  <IconButton onClick={() => userWidjet.setIsComponentVisible(!userWidjet.isComponentVisible)}>
                                      <Avatar sx={{ border: `1px solid black` }}/>
                                  </IconButton>
                              </> :
            <>
                                      <button onClick={() => dispatch(changeRole("customer"))} className={`${styles.roleBtn} ${userSlice.role === 'customer' && styles.active}`}>
                                        {t('customer')}
                                      </button>

                                      <button onClick={() => dispatch(changeRole("executor"))} className={`${styles.roleBtn} ${userSlice.role === 'executor' && styles.active}`}>
                                          {t('executor')}
                                      </button>
