...
export const postUserAuth = createAsyncThunk(`get-info/user`, async (data, { rejectWithValue }) => {
    try {
...
export const { setRecoverPass, changeTypeAuth, changeCreatedAdRole, changeRole, createdAdStatus, setUserData, setPublications, setLogout, setUserComments, setPublicationForm } = UserSlice.actions;
