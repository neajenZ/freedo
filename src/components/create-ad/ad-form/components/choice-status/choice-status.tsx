...
export const CreateAdStatus = () => {
    ...
    const choiceStatus = (e: React.MouseEvent<HTMLSpanElement>) => {
    ...
    return (
        <div className={styles.formItem}>
            ...
            <div className={styles.buttonWrapper}>
                ...
                <button
                    className={`${styles.statusBtn} ${userSlice.createAdInfo.data.status === 'Ищу постоянную работу' ? styles.active : ''}`}
                    onClick={choiceStatus}
                >
                    Ищу постоянную работу
                </button>

                <button
                    className={`${styles.statusBtn} ${userSlice.createAdInfo.data.status === 'Ищу стажировку' ? styles.active : ''}`}
                    onClick={choiceStatus}
                >
                    Ищу стажировку
                </button>
                ...
                <button
                    className={`${styles.statusBtn} ${userSlice.createAdInfo.data.status === 'Сотрудничество попроектно' ? styles.active : ''}`}
                    onClick={choiceStatus}
                >
