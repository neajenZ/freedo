    ...
    return (<form className={styles.formWrapper}>
            <div className={`${styles.formItem} ${styles.roleWrapper}`}>
                ...
                <div className={styles.buttonWrapper}>
                    ...
                    <button className={userSlice.createAdInfo.data.type === 'executor' ? styles.active : undefined} onClick={() => dispatch(setPublicationForm({
            ...
            data: {
                ...
                type: 'executor'
                    ...
                    <button className={userSlice.createAdInfo.data.type === 'customer' ? styles.active : undefined} onClick={() => dispatch(setPublicationForm({
            ...userSlice.createAdInfo,
            data: {
                ...userSlice.createAdInfo.data,
                type: 'customer'
            ...
            <div className={styles.formItem}>
                ...
                <div className={styles.inputValidWrapper}>
                    <input type="text" placeholder={'Введите название'} {...register('title', {
        required: 'Поле обязательно к заполнению'
            ...
            <div className={`${styles.formItem} ${styles.fieldWrapper}`}>
                <h4>Описание:</h4>
                <div className={styles.inputValidWrapper}>
                    <textarea placeholder={'Введите название'} {...register('description', {
        required: 'Поле обязательно к заполнению',
        minLength: {
            value: 50,
            ...
            <div className={`${styles.formItem} ${styles.price}`}>
                <h4>Стоимость:</h4>
                <div className={styles.inputValidWrapper}>
                    <input className={styles.priceInput} placeholder={'Введите стоимость'} type='number' {...register('price', {
        required: 'Поле обязательно к заполнению',
    })}/>
            ...
            <div className={styles.formItem}>
                ...
                <input className={`${styles.stepBtn}`} type='submit' value={'Далее'}/>
            </div>
        </form>);
};
